...
public class Customer extends User implements Serializable
{
  ...
  public boolean resetGugutime()
  {
    boolean wasReset = false;
    gugutime = getDefaultGugutime();
    wasReset = true;
    return wasReset;
  }
  ...
  public String toString()
  {
    return super.toString() + "["+
            "gugutime" + ":" + getGugutime()+ "]" + System.getProperties().getProperty("line.separator") +
